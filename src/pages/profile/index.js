...
const getUrl = process.env.REACT_APP_BASEURL + "/user/";
const urlUpdate = process.env.REACT_APP_BASEURL + "/user/img/";
      ...
      <>
        ...
        {localStorage.getItem("token").name === null ? (
          ...
          <div className="container section-profile d-flex justify-content-center flex-column align-items-center">
            <div className="img-profile-section">
              <img
                alt="user-profile"
                src={profile.user_img ? profile.user_img : UserIcon}
                className="img-profile"
              />
              <img
                alt="pen-edit"
                src={Edit}
                className="edit-profile clicked"
                onClick={() => {
                  this.setState({
              ...
              <div className="update-photo-pass mt-3 ">
                <form className="w-100">
                  <div className="button-wrap">
                    ...
                    <input
                      className="inpt-update-user input-profile"
                      id="upload"
                      type="file"
                      onChange={(e) => {
                        this.handleUpload(e);
                ...
                <div className="w-100 d-flex justify-content-center">
                  <Link
                    to="/resetPassword"
                    className="text-decoration-none txt-change-pass"
                  >
                    Change Password
                  </Link>
                </div>
        ...
        <div className="container-fluid pl-xl-5 pr-xl-5">
          <div className="col-md-5 col-lg-4 col-xl=3 d-flex flex-column flex-sm-row justify-content-between pl-3 pl-xl-5 pr-3 pr-xl-5">
            <Link
              to="/profile/myrecipe"
              className="txt-profile font-weight-medium clicked text-decoration-none text-nowrap mb-3 mb-sm-0 mr-md-4 mr-lg-5 text-center"
            >
              My Recipe
            </Link>
            <Link
              to="/profile/saved"
              className="txt-profile font-weight-medium clicked text-decoration-none text-nowrap mb-3 mb-sm-0 text-center"
            >
              Saved Recipe
            </Link>
            <Link
              to="/profile/liked"
              className="txt-profile font-weight-medium clicked text-decoration-none text-nowrap mb-3 mb-sm-0 ml-md-4 ml-lg-5 text-center"
            >
              Liked Recipe
            </Link>
          </div>
        ...
        <div className="container-fluid pl-xl-5 pr-xl-5 mt-4">
          <div className="pl-0 pl-xl-4 pr-0 pr-xl-4 d-flex flex-wrap">
            <Switch>
              ...
              <Route
                exact
                path={`${this.props.match.path}/myrecipe`}
                component={MyRecipes}
              />
              <Route
                exact
                path={`${this.props.match.path}/saved`}
                component={Saved}
              />
              <Route
                exact
                path={`${this.props.match.path}/liked`}
                component={Liked}
              />
              <Route
                path="*"
