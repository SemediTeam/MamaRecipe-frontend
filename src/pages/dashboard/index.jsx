  ...
  render() {
    return (
      <>
        ...
        <div className="position-relative w-100 full-h pl-0 pl-xl-5 pr-0 pr-xl-5" style={{marginTop:'-5.6875rem'}}></div>
        <div className="position-relative w-100 full-h d-flex flex-column pl-0 pl-xl-5 pr-0 pr-xl-5">
          ...
          <div className="w-100 pl-0 pl-xl-5 pr-0 pr-xl-5 pt-5 d-flex flex-row justify-content-between h-100">
        ...
        <div className="position-relative w-100 full-h d-flex flex-column pl-0 pl-xl-5 pr-0 pr-xl-5">
          ...
          <div className="position relative w-100 pl-0 pl-xl-5 pr-0 pr-xl-5 pt-5 mt-5 d-flex flex-row justify-content-between h-100">
            <div className="col-md-6 d-none d-md-flex p-0 pl-0 pl-md-3">
              <div className="col-5 position-absolute pl-0 pb-5 dashboard-custom-new" style={{zIndex:-1, left: '-100px', top:'-50px'}}>
