    ...
    return (
      <>
        ...
        <div className="dashboard position-absolute container-fluid p-0">
          <div className="position-relative w-100 d-flex justify-content-between pl-3 pl-xl-5 pr-0" style={{height:'100vh'}}>
            ...
            <div className="col-12 col-md-8 pl-0 pl-md-3 pl-xl-5 pr-0 h-100 d-flex align-items-center">
              <div className="d-flex flex-column col-12 col-sm-10 col-md-8 col-lg-7 col-xl-6 pl-0">
            ...
            <div className="h-100 d-none d-md-flex col-md-4 pr-3 pr-xl-5 pl-0" style={{backgroundColor: '#EFC81A'}}>
