      ...
      <>
        <div className="w-100 full-h d-flex flex-column pl-0 pl-xl-5 pr-0 pr-xl-5">
          ...
          <div className="w-100 p-0 pl-3 pl-xl-5 pr-3 pr-xl-5 mt-5 d-flex flex-row flex-wrap">
            {recipe &&
              recipe.map(({ recipe_name, id_recipe, recipe_img }) => {
                // console.log(JSON.parse(recipe_img[0]))
                return (
                  <div
                    className="col-12 col-sm-6 col-md-4 d-flex justify-content-center mb-3 mb-sm-4 mb-lg-5 p-0 px-sm-2 px-lg-3"
                    key={id_recipe}
                  >
