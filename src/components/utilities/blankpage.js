...
export default function blankpage() {
  return (
    <div className="container-fluid full-h d-flex flex-column justify-content-center align-items-center position-absolute bg-light" style={{zIndex:99,top:0,left:0}}>
      ...
      <Link className="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-4 d-flex justify-content-center text-decoration-none" to="/">
        <Button variant="warning" type="submit" className="w-75 btn-main pt-2 pb-2 font-weight-medium text-dark">
          Go Back
        </Button>
      </Link>
    </div>
