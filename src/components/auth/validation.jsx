      ...
      <>
        <Form className="w-100 mb-3 mt-3" onSubmit={this.handlerSubmit}>
          <Form.Group controlId="formBasicEmail">
            ...
            <Form.Control type="number" placeholder="Enter 6 digit codes" name="otp" className="pt-4 pb-4 pl-4 pr-0 input-auth" required onChange={(e)=>{this.handlerChange(e)}}/>
          </Form.Group>
