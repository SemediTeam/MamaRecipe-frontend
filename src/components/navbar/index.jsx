...
class NavbarSticky extends Component {
  ...
  conditionalAuth = () => {
    ...
    if (auth.isLogin) {
      return (
        <p
          className="m-0 clicked text-dark"
          onClick={async (e) => {
            e.preventDefault();
      ...
      return (
        <>
          <Link to="/auth/signin" className="m-0 clicked text-dark">
            Login
          </Link>
          <p className="m-0 mx-3">|</p>
          <Link to="/auth/signup" className="m-0 clicked text-dark">
            Register
          </Link>
        </>
      );
  ...
  render() {
    ...
    return (
      <>
        <div
          className={`${this.state.Scroll} d-flex align-items-center nav-small`}
        >
          <Navbar
            collapseOnSelect
            expand="md"
          ...
          >
            ...
            >
              <Nav className="mr-auto p-0 col-12 col-md-4 col-lg-3 col-xl-4 pr-0 pr-xl-5 mb-4 mb-md-0 font-weight-medium align-items-center justify-content-md-start">
                <Nav
                  className="clicked p-0 m-0 mr-md-5 mb-4 mb-md-0"
                  onClick={(e) => {
                    e.preventDefault();
                ...
                <Nav
                  className="clicked p-0 m-0 text-nowrap mb-4 mb-md-0"
                  onClick={(e) => {
                    e.preventDefault();
              ...
              <Nav>
                <Navbar.Brand className="col-12 d-flex d-md-none align-items-center justify-content-center text-decoration-none font-weight-medium m-0 p-0">
                  <img
                    src={img !== undefined ? img : UserIcon}
                    alt="user"
                    className="rounded-circle navbar-user-icon clicked"
                    onClick={(e) => {
                      e.preventDefault();
                      this.props.history.push("/profile");
                    }}
